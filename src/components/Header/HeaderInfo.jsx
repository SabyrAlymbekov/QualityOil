    ...
    return <div className="HeaderInfo container">
        <div className="HeaderInfo__infos">
            <div className="HeaderInfo__address">
                ...
                <h3 className="HeaderInfo__point">371 просп. Жибек Жолу</h3>
            </div>
            <div className="HeaderInfo__phones">
                ...
                <div className="HeaderInfo__numbers">
                    <h3 className="HeaderInfo__number">+996 312 466371</h3>
                    <h3 className="HeaderInfo__number">+996 707 466371</h3>
                    <h3 className="HeaderInfo__number">+996 777 466371</h3>
                    <h3 className="HeaderInfo__number">+996 555 466371</h3>
                </div>
            </div>
        </div>
